...
@section('page_title', 'Viendo Categoria de Producto')
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body" style="padding: 0px">
                        <div class="col-md-8" style="padding: 0px">
                            <h1 class="page-title">
                                <i class="fa-solid fa-sitemap"></i> Categorias de Productos
                            </h1>
                        </div>
                        <div class="col-md-4 text-right" style="margin-top: 30px">
                            @if (!auth()->user()->hasRole('admin') && auth()->user()->hasPermission('add_categories'))
...
@section('content')
    <div class="page-content browse container-fluid">
        ...
        <form id="form-search" action="{{ route('categories.store') }}" method="post">
            @csrf
