                    ...
                    <div class="panel-body" style="padding: 0px">
                        <div class="col-md-8" style="padding: 0px">
                            <h1 id="subtitle" class="page-title">
                                <i class="voyager-truck"></i> Proveedor
                            </h1>
                        </div>
...
@section('content')
    <div class="page-content browse container-fluid">
                                        ...
                                        <tr>
                                            ...
                                            @if (!auth()->user()->hasRole('admin') && auth()->user()->hasPermission('add_providers'))
                                                <td style="text-align: right">
                                                        <a href="" title="Editar" class="btn btn-sm btn-primary" data-item="{{ $item}}" data-toggle="modal" data-target="#1edit_modal">
        ...
        <form id="form-search" action="{{ route('providers.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="modal-dialog modal-success modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"><i class="voyager-truck"></i> Registrar Proveedor</h4>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" cols="67" rows="5"></textarea>
                                    </div>
                                </div>   
                            </div>
                        </div>
